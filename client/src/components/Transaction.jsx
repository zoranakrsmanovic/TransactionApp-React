...
const TransactionsCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }) => {
  ...
  return (
    <div className=" transacrion-bg m-4 flex flex-1
      2xl:min-w-[450px]
      2xl:max-w-[500px]
      sm:min-w-[270px]
      sm:max-w-[300px]
      min-w-full
      flex-col p-3 rounded-md hover:shadow-6xl"
    >
      <div className="flex flex-col items-center w-full mt-2 ">
        ...
        <div className="white-glassmorphism p-3 px-5 w-max rounded-3xl -mt-5 shadow-2xl">
          <p className="text-[#94bbe9] font-bold">{timestamp}</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-services">
      <div className="flex flex-col md:p-12 py-12 px-4">
        {currentAccount ? (
          ...
          <h3 className="text-white text-3xl text-center my-2">
            Connect your account to see the your transactions
          </h3>
        )}
